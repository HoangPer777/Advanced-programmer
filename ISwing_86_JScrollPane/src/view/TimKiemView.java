...
//		Font font = new Font("Arial", Font.BOLD, 40);
		Font font = new Font("time new roman", Font.ITALIC, 40);
...
//		JScrollPane jScrollPane = new JScrollPane(jTextArea_vanBan, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		...
		jButton_thongKe.setBorderPainted(false); // loại bỏ viền xung quanh của button 
		jButton_thongKe.setOpaque(true); // Làm cho JButton hiển thị đầy đủ màu sắc của nó
