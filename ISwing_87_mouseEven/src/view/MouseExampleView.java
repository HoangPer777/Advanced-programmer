...
public class MouseExampleView extends JFrame{
	...
	private void init() {
		...
		jPanel_mouse.addMouseListener(mouseExampleController);// để theo dõi sự kiện chuột trên JPanel, ví dụ như nhấn chuột, nhả chuột, click chuột, vv.
		jPanel_mouse.addMouseMotionListener(mouseExampleController); //  để theo dõi các sự kiện chuột di chuyển trên JPanel, ví dụ như kéo chuột, thả chuột khi đang di chuyển, vv.
