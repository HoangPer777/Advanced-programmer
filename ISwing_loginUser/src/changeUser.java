 ...
 * Khung menu có hành động Tệp -> Kết nối hiển thị hộp thoại mật khẩu.
 */
class DataExchangeFrame extends JFrame {
	...
	/**
	 * The Connect action pops up the password dialog. Hành động Kết nối bật lên hộp
	 * thoại mật khẩu.
	 */
	private class ConnectAction implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			// if first time, construct dialog
			// nếu lần đầu, xây dựng hộp thoại
			if (dialog == null)
