...
public class MainPanel extends JPanel {
	...
	JLabel titleLabel, idStudentLabel, nameStudentLabel, idClassLabel, listSubjectLabel;
...
//		setLayout(new GridLayout(4,1));
		...
		submitButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String[] newRow = { String.valueOf(count++), student.getId(), student.getName(), student.getIdclass(),
						student.getSubject() };
